...
namespace DBConnection
{
    public class Ostali : FizickoLice
    {
        ...
        public Ostali(string brojTelefona, string email, string adresa, string grad, string biljeske, string ime, string prezime, string licnaKarta, string jmbg, string nazivFirme, string adresaFirme, string radnoMjesto)
            : base(brojTelefona, email, adresa, grad, biljeske, ime, prezime, licnaKarta, jmbg)
        {
